...
Versions 2 and above tested on teensy 4.1, with OctoWS2811 and builtin SD slot on the board.
...
User should call the function `bool setup()` once to initialize the object.
